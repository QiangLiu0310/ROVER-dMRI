...
Adds weight_mode='sliceprofile' to load depth weights from rf_slice_profile_mse_sinc.mat
(z_mm, Mse_sinc).
"""
...
if os.path.exists(affine_path):
    ...
    print(f"Number of depth layers: ceil({depth_ratio:.6f}) = {num_depth_layers}")
